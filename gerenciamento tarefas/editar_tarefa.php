...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    $dados = $pdo->prepare("UPDATE tasks SET task_text = ?, task_date = ?, assign_value = ?, priority_value = ? WHERE id = ?");
    $dados->execute([$taskText, $taskDate, $assignValue, $priorityValue, $taskId]);
